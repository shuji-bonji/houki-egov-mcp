...
| パッケージ              | 対象                          | 想定時期 |
| ----------------------- | ----------------------------- | -------- |
| `@houki-hub/ext-nta`     | 国税庁基本通達・措置法通達    | Phase 3  |
| `@houki-hub/ext-mhlw`    | 厚生労働省通達                | Phase 3  |
| `@houki-hub/ext-jaish`   | 安全衛生情報センター通達      | Phase 3  |
| `@houki-hub/ext-saiketsu` | 国税不服審判所 公表裁決事例   | Phase 3  |
