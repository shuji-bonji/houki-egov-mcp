...
| パッケージ名              | 対象                                 | 主な実務テーマ                               | 参考既存実装                    |
| ------------------------- | ------------------------------------ | -------------------------------------------- | ------------------------------- |
| `@houki-hub/ext-nta`      | 国税庁 通達・告示・Q&A               | 電帳法・インボイス・税務全般                 | `kentaroajisaka/tax-law-mcp`    |
| `@houki-hub/ext-saiketsu` | 国税不服審判所 公表裁決事例          | 税務争訟                                     | 同上                            |
| `@houki-hub/ext-mhlw`     | 厚生労働省 通達・告示                | 労務・社保                                   | `kentaroajisaka/labor-law-mcp`  |
| `@houki-hub/ext-jaish`    | 安全衛生情報センター（JAISH）通達    | 労安全衛                                     | 同上                            |
...
| `@houki-hub/ext-court`    | 裁判所 判決検索（民事・刑事・行政）  | 判例                                         | —（下記 Stage A〜C で段階実装） |
